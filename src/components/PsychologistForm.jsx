...
import { X, User, Mail, Phone, Award, Clock } from 'lucide-react';
import { Button } from '@/components/ui/button';

const PsychologistForm = ({ psychologist, onSubmit, onCancel }) => {
      ...
      >
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-900">
              {psychologist ? 'Editar Psicólogo' : 'Nuevo Psicólogo'}
            </h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            >
              {psychologist ? 'Actualizar Psicólogo' : 'Crear Psicólogo'}
            </Button>
          </div>
        </form>
      </motion.div>
